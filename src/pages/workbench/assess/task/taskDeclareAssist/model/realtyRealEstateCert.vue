<template>
	<view>
		<view>
			<data-cnpm-model @submit="submit" ref="realtyRealEstateModel" :dataId="data.id" :bisCenter="bisCenter"
				:controlParam="controlParam" :bisDetail="bisDetail">
				<uni-group title="附件" mode="card" slot="foot">
					<uni-forms-item name="declareRealtyRealEstateCertNewFileId" label="不动产权证" label-align="right">
