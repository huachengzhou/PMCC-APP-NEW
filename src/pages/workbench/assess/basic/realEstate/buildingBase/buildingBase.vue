		...
		<uni-forms :modelValue="formData" ref="form" validate-trigger="bind" err-show-type="undertext" :rules="rules">
			<uni-group title="基本信息" mode="card">
				...
				<uni-forms-item required name="buildingHeight" label="建筑高度" label-align="right">
					<uni-easyinput   type="text" v-model="formData.buildingHeight"
						placeholder="建筑高度" />
				</uni-forms-item>
				...
				<uni-forms-item  name="facilitiesUseFee" label="配套公共设施使用费" label-align="right">
					<uni-easyinput   type="text" v-model="formData.facilitiesUseFee"
						placeholder="配套公共设施使用费" />
				</uni-forms-item>
				...
				<uni-forms-item v-show="completedTimeTypeName != '无法获取' " name="beCompletedTime" label="竣工时间" label-align="right">
				...
				<uni-forms-item v-show="completedTimeTypeName != '无法获取' " name="constructionQuality" label="工程质量" label-align="right">
			...
			<uni-group title="补充信息" mode="card">
				<uni-forms-item name="landUseYear" label="土地使用年限" label-align="right">
					<uni-easyinput   type="text" v-model="formData.landUseYear"
						placeholder="土地使用年限" />
				</uni-forms-item>
				<uni-forms-item name="coverAnArea" label="占地面积(平方米)" label-align="right">
					<uni-easyinput   type="text" v-model="formData.coverAnArea"
				...
				<uni-forms-item v-show="propertyServiceTypeFlag" name="propertyCompanyNature" label="物业公司性质" label-align="right">
				...
				<uni-forms-item v-show="propertyServiceTypeFlag" name="propertySocialPrestige" label="物业公司社会信誉" label-align="right">
				...
				<uni-forms-item v-show="propertyServiceTypeFlag" name="propertyName" label="物业公司名称" label-align="right">
					<uni-easyinput   type="text" v-model="formData.propertyName"
						placeholder="物业公司名称" />
				</uni-forms-item>
