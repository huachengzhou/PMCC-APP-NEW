	...
	<view style="margin-top: 40px;">
		...
		<uni-forms :modelValue="formData" ref="form" validate-trigger="bind" err-show-type="undertext" :rules="rules">
			<uni-group title="基本信息" mode="card">
				...
				<uni-forms-item required name="elevatorHouseholdRatio" label="梯户比" label-align="right">
					<uni-easyinput type="text" v-model="formData.elevatorHouseholdRatio" placeholder="梯户比" />
				</uni-forms-item>
