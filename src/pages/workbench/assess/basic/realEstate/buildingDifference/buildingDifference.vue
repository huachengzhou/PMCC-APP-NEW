	...
	<view style="margin-top: 40px;">
		...
		<uni-forms :modelValue="formData" ref="form" validate-trigger="bind" err-show-type="undertext" :rules="rules">
			<uni-group title="基本信息" mode="card">
				...
				<uni-forms-item  name="firstFloor" label="首层位置" label-align="right">
					<uni-easyinput   type="text" v-model="formData.firstFloor" placeholder="首层位置" />
				</uni-forms-item>
				<uni-forms-item  name="maxFloor" label="最高层" label-align="right">
					<uni-easyinput   type="text" v-model="formData.maxFloor" placeholder="最高层" />
				</uni-forms-item>
				<uni-forms-item  name="floorHeight" label="层高" label-align="right">
				...
				<uni-forms-item  name="buildingArea" label="建筑面积(平方米)" label-align="right">
					<uni-easyinput   type="text" v-model="formData.buildingArea"
						placeholder="建筑面积(平方米)" />
				</uni-forms-item>
				<uni-forms-item  name="propertyFee" label="物业费(平方米)" label-align="right">
					<uni-easyinput   type="text" v-model="formData.propertyFee"
						placeholder="物业费(平方米)" />
				</uni-forms-item>

				<uni-forms-item name="building_floor_plan" label="平面图" label-align="right">
					<common-image-picker :dataObj="setImgFieldsName('building_floor_plan')">
					</common-image-picker>
				</uni-forms-item>

				<uni-forms-item name="building_figure_outside" label="外装图" label-align="right">
					<common-image-picker :dataObj="setImgFieldsName('building_figure_outside')">
					</common-image-picker>
				</uni-forms-item>

				<uni-forms-item name="building_floor_Appearance_figure" label="外观图" label-align="right">
					<common-image-picker :dataObj="setImgFieldsName('building_floor_Appearance_figure')">
					</common-image-picker>
				</uni-forms-item>
				
				<uni-forms-item name="building_number_plan" label="楼栋号" label-align="right">
					<common-image-picker :dataObj="setImgFieldsName('building_number_plan')">
					</common-image-picker>
				</uni-forms-item>
