...
<script>
	...
	let ruleField = [
		...
		'northTo',
		'landAreaUnit', 'shapeState', 'planeness', 'topographicTerrain', 'shapeStateRemark', 'developmentDegree',
		'developmentDegreeContent', 'presentSituationLandUse', 'contaminated', 'ph', 'holdOn',
		'developmentDegreeRemark',
		'bearingCapacity', 'plotRatio', 'buildingDensity', 'greenSpaceRate', 'compatibleRatio'
	];
