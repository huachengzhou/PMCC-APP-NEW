	...
	<view style="margin-top: 40px;">
		<uni-forms :modelValue="formData" ref="form" validate-trigger="bind" err-show-type="undertext" :rules="rules">
			<uni-group title="基本信息" mode="card">
				...
				<uni-forms-item name="equipmentPrice" label="设备价格区间" label-align="right">
	...
	export default {
		...
		methods: {
			...
			initListData() {
				...
				estateCommonUtils.loadAsyncDataDicByKey(AssessDicKey.examine_house_wind_equipment_price_range, function(
				    resultData) {
				    if (!resultData) {
				        return false;
				    }
				...
				estateCommonUtils.loadAsyncDataDicByKey(AssessDicKey.examine_house_way_wind, function(
				    resultData) {
				    if (!resultData) {
				        return false;
				    }
