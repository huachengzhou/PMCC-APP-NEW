				...
				<!-- <view class="uni-container">
					<uni-table :loading="loading" border stripe emptyText="暂无更多数据">
						<uni-tr>
							...
							<uni-th align="center">供电保障等级</uni-th>
							<uni-th align="center">供电商信誉</uni-th>
							<uni-th align="center">供电商等级</uni-th>
...
<script>
	...
	export default {
		...
		onNavigationBarButtonTap() {
			...
			uni.navigateTo({
				url: "./basicEstateSupplyEstateSupplyPowerEdit?" + utils.parseParam(param)
			});
		},
		onLoad(option) {
			let cardObj = {};
