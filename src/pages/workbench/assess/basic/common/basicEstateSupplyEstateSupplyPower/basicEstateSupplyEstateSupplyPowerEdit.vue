	...
	<view style="margin-top: 40px;">
		<uni-forms :modelValue="formData" ref="form" validate-trigger="bind" err-show-type="undertext" :rules="rules">
			<uni-group title="基本信息" mode="card">
				<uni-forms-item required name="name" label="供应商名称" label-align="right">
					<uni-easyinput  type="text" v-model="formData.name" placeholder="供应商名称" />
				</uni-forms-item>


				<uni-forms-item required name="lineGrade" label="供电保障等级" label-align="right">
				...
				<uni-forms-item required name="reputation" label="供电商信誉" label-align="right">
				...
				<uni-forms-item required name="grade" label="供电商等级" label-align="right">
