			...
			<z-paging ref="paging" :fixed=true @query="queryPageList" v-model="DetailList">
				...
				<!-- <view class="uni-container">
					<uni-table :loading="loading" border stripe emptyText="暂无更多数据">
						<uni-tr>
							<uni-th align="center">供热商名称</uni-th>
							<uni-th align="center">供热保障等级</uni-th>
							<uni-th align="center">供热商信誉</uni-th>
							<uni-th align="center">供热商等级</uni-th>
...
<script>
	...
	export default {
		...
		onNavigationBarButtonTap() {
			...
			uni.navigateTo({
				url: "./basicEstateSupplyEstateSupplyHeatingEdit?" + utils.parseParam(param)
			});
		},
		onLoad(option) {
			let cardObj = {};
