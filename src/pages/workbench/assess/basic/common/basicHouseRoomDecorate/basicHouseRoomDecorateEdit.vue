	...
	<view style="margin-top: 40px;">
		<uni-forms :modelValue="formData" ref="form" validate-trigger="bind" err-show-type="undertext" :rules="rules">
			<uni-group title="基本信息" mode="card">
				...
				<uni-forms-item required name="part" label="房间装修部位" label-align="right">
				...
				<uni-tag :disabled="true" text="所在位置选项来源于房间名称" type="primary" size="small" />
				<uni-forms-item name="location" label="所在位置" label-align="right">
					<select-input :dataValue="formData.location" :dataInput="'location'" :selectDatas="locationList"
				...
				<uni-forms-item name="remark" label="部位描述" label-align="right">
...
<script>
	...
	import selectInput from '@/components/select-Input/select-Input-mul.vue';
		...
		methods: {
			...
			initListData() {
				...
				this.$myRequest.pmccRequest({
					url: "/app.assess/basicHouseRoom/getPageResult",
					method: "POST",
					data: {
						pageNum: 1,
						pageSize: 50,
