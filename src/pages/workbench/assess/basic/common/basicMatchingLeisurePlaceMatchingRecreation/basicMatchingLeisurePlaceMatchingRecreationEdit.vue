	...
	<view style="margin-top: 40px;">
		<uni-forms :modelValue="formData" ref="form" validate-trigger="bind" err-show-type="undertext" :rules="rules">
			<uni-group title="基本信息" mode="card">
				...
				<!-- <uni-forms-item required name="name" label="休闲娱乐名称" label-align="right">
					<uni-easyinput  type="text" v-model="formData.name" placeholder="休闲娱乐名称" />
				</uni-forms-item> -->
				...
				<assess-multiple-input-group  :label="'休闲娱乐名称'"  :values="nameList"
					@updateResult="updateFormData" @rmoveResult="removeInput">
				</assess-multiple-input-group>


				<uni-forms-item required name="category" label="休闲娱乐类别" label-align="right">
				...
				<uni-forms-item required name="distance" label="休闲娱乐距离" label-align="right">
	...
	export default {
		...
		methods: {
			...
			initListData() {
				...
				estateCommonUtils.loadAsyncDataDicByKey(AssessDicKey.estate_entertainment_category, function(
				    resultData) {
				    if (!resultData) {
				        return false;
				    }
