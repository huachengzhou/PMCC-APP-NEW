	...
	export default {
		...
		methods: {
			...
			initListData() {
				...
				estateCommonUtils.loadAsyncDataDicByKey(AssessDicKey.examine_house_air_equipment_price_range, function(
				    resultData) {
				    if (!resultData) {
				        return false;
				    }
				...
				estateCommonUtils.loadAsyncDataDicByKey(AssessDicKey.examine_house_air_conditioning_mode, function(
				    resultData) {
				    if (!resultData) {
				        return false;
				    }
