			...
			<z-paging ref="paging" :fixed=true @query="queryPageList" v-model="DetailList">
				...
				<!-- <view class="uni-container">
					<uni-table :loading="loading" border stripe emptyText="暂无更多数据">
						<uni-tr>
							<uni-th align="center">设备品牌</uni-th>
							<uni-th align="center">类别</uni-th>
							<uni-th align="center">档次</uni-th>
							<uni-th align="center">供应方式</uni-th>
							<uni-th align="center">设备价格区间</uni-th>
							<uni-th align="center">操作</uni-th>
						</uni-tr>
						<uni-tr v-for="(itemData, index) in DetailList" :key="index">
							<uni-td>{{getItemShowName(itemData.equipment)}} </uni-td>
							...
							<uni-td>{{getItemShowName(itemData.equipmentPriceName)}} </uni-td>
							<uni-td>
...
<script>
	...
	export default {
		...
		onNavigationBarButtonTap() {
			...
			uni.navigateTo({
				url: "./basicHouseEquipmentHouseAirConditionerEdit?" + utils.parseParam(param)
			});
		},
		onBackPress() {
