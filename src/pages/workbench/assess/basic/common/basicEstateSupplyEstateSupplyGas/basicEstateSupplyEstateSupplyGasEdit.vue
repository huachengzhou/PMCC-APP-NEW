	...
	<view style="margin-top: 40px;">
		<uni-forms :modelValue="formData" ref="form" validate-trigger="bind" err-show-type="undertext" :rules="rules">
			<uni-group title="基本信息" mode="card">
				...
				<uni-forms-item required name="lineGrade" label="供气保障等级" label-align="right">
				...
				<uni-forms-item required name="reputation" label="供气商信誉" label-align="right">
				...
				<uni-forms-item required name="grade" label="供气商等级" label-align="right">
