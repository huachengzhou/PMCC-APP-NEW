				...
				<!-- <view class="uni-container">
					<uni-table :loading="loading" border stripe emptyText="暂无更多数据">
						<uni-tr>
							...
							<uni-th align="center">供气保障等级</uni-th>
							<uni-th align="center">供气商信誉</uni-th>
							<uni-th align="center">供气商等级</uni-th>
...
<script>
	...
	export default {
		...
		onNavigationBarButtonTap() {
			...
			uni.navigateTo({
				url: "./basicEstateSupplyEstateSupplyGasEdit?" + utils.parseParam(param)
			});
		},
		onLoad(option) {
			let cardObj = {};
