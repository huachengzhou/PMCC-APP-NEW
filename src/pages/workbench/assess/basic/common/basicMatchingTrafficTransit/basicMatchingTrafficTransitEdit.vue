	...
	<view style="margin-top: 40px;">
		<uni-forms :modelValue="formData" ref="form" validate-trigger="bind" err-show-type="undertext" :rules="rules">
			<uni-group title="基本信息" mode="card">
				...
				<!-- <uni-forms-item  name="theLine" label="所在线路" label-align="right">
					<uni-easyinput  type="text" v-model="formData.theLine" placeholder="所在线路" />
				</uni-forms-item> -->
				...
				<assess-multiple-input-group ref="theLine" :label="'所在线路'"  :values="theLineList"
			...
			submitForm() {
				...
				this.$refs.form.validate().then((res) => {
					let data = utils.assignObj(res, {
						...
						bisDelete: 'false',
						theLine: _this.theLineList.join(",")
					});
			...
			setServerData(url) {
				...
				let option = {
					...
					successCallback: function(resultData) {
						...
						_this.initListData();
						_this.theLineList = utils.splitString(formData.theLine);
