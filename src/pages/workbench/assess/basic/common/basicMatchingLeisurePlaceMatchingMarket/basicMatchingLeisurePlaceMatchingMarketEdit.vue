	...
	<view style="margin-top: 40px;">
		<uni-forms :modelValue="formData" ref="form" validate-trigger="bind" err-show-type="undertext" :rules="rules">
			<uni-group title="基本信息" mode="card">
				...
				<assess-multiple-input-group  :label="'购物商场名称'"  :values="nameList"
					@updateResult="updateFormData" @rmoveResult="removeInput">
				</assess-multiple-input-group>
				
				
				<!-- <uni-forms-item required name="name" label="购物商场名称" label-align="right">
					<uni-easyinput  type="text" v-model="formData.name" placeholder="购物商场名称" />
				</uni-forms-item> -->


				<uni-forms-item required name="category" label="购物商场类别" label-align="right">
				...
				<uni-forms-item required name="grade" label="购物商场档次" label-align="right">
				...
				<uni-forms-item required name="distance" label="购物商场距离" label-align="right">
	...
	export default {
		...
		methods: {
			...
			initListData() {
				...
				estateCommonUtils.loadAsyncDataDicByKey(AssessDicKey.estate_shop_category, function(
				    resultData) {
				    if (!resultData) {
				        return false;
				    }
				...
				estateCommonUtils.loadAsyncDataDicByKey(AssessDicKey.estate_shop_grade, function(
				    resultData) {
				    if (!resultData) {
				        return false;
				    }
