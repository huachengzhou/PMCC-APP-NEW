			...
			<z-paging ref="paging" :fixed=true @query="queryPageList" v-model="DetailList">
				...
				<!-- <view class="uni-container">
					<uni-table :loading="loading" border stripe emptyText="暂无更多数据">
						<uni-tr>
							<uni-th align="center">购物商场名称</uni-th>
							<uni-th align="center">购物商场类别</uni-th>
							<uni-th align="center">购物商场档次</uni-th>
							<uni-th align="center">购物商场距离</uni-th>
...
<script>
	...
	export default {
		data() {
			return {
				dataFilterDicByKey: AssessDicKey.DATA_BASE_MAP_FILTER_MARKET,
				fieldList: fieldList,
				cardObj: null,
				batchDetail: null,
				DetailList: [],
		...
		onNavigationBarButtonTap() {
			...
			uni.navigateTo({
				url: "./basicMatchingLeisurePlaceMatchingMarketEdit?" + utils.parseParam(param)
			});
		},
		onLoad(option) {
			let cardObj = {};
		...
		computed: {
			dataKey() {
				let key = AssessDicKey.estate_shop_category;
				return key;
			}
		},
		methods: {
