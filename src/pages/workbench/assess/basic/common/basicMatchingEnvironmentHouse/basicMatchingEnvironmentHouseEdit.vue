	...
	<view style="margin-top: 40px;">
		<uni-forms :modelValue="formData" ref="form" validate-trigger="bind" err-show-type="undertext" :rules="rules">
			<uni-group title="基本信息" mode="card">
				...
				<uni-forms-item required name="type" label="景观类型" label-align="right">
				...
				<uni-forms-item required name="remark" label="景观描述" label-align="right">
					<uni-easyinput  type="text" v-model="formData.remark" placeholder="景观描述" />
				</uni-forms-item>


				<uni-forms-item required name="humanImpact" label="影响结论" label-align="right">
	...
	export default {
		...
		methods: {
			...
			changeLoadData: function(name) {
				...
				switch (name) {
					case "type": {
						estateCommonUtils.getDataDicListByPid(formData[name], function(
							resultData) {
							if (!resultData) {
								return false;
							}
