	...
	<view style="margin-top: 40px;">
		<uni-forms :modelValue="formData" ref="form" validate-trigger="bind" err-show-type="undertext" :rules="rules">
			<uni-group title="基本信息" mode="card">
				<uni-forms-item required name="name" label="废水处理商名称" label-align="right">
					<uni-easyinput  type="text" v-model="formData.name" placeholder="废水处理商名称" />
				</uni-forms-item>


				<uni-forms-item required name="lineGrade" label="排水保障等级" label-align="right">
				...
				<uni-forms-item required name="reputation" label="废水处理商信誉" label-align="right">
				...
				<uni-forms-item required name="grade" label="废水处理商等级" label-align="right">
					<assess-picker :dataInput="'grade'" :dataList="gradeList" :dataValue="formData.grade"
						@dataResult="initFormPickerResult">
					</assess-picker>
				</uni-forms-item>
				<uni-forms-item  name="power" label="排水量或功率" label-align="right">
					<uni-easyinput  type="text" v-model="formData.power" placeholder="排水量或功率" />
				</uni-forms-item>
			</uni-group>
		</uni-forms>
