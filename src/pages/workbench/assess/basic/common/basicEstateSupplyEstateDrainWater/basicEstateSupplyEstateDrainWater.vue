			...
			<z-paging ref="paging" :fixed=true @query="queryPageList" v-model="DetailList">
				...
				<!-- <view class="uni-container">
					<uni-table :loading="loading" border stripe emptyText="暂无更多数据">
						<uni-tr>
							<uni-th align="center">废水处理商名称</uni-th>
							<uni-th align="center">排水保障等级</uni-th>
							<uni-th align="center">废水处理商信誉</uni-th>
							<uni-th align="center">废水处理商等级</uni-th>
							<uni-th align="center">排水量或功率</uni-th>
...
<script>
	...
	export default {
		...
		onNavigationBarButtonTap() {
			...
			uni.navigateTo({
				url: "./basicEstateSupplyEstateDrainWaterEdit?" + utils.parseParam(param)
			});
		},
		onLoad(option) {
			let cardObj = {};
