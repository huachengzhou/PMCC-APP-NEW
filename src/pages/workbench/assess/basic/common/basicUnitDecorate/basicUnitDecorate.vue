				...
				<!-- <view class="uni-container">
					<uni-table :loading="loading" border stripe emptyText="暂无更多数据">
						<uni-tr>
							...
							<uni-th align="center">装修部位</uni-th>
							<uni-th align="center">装修材料</uni-th>
							<uni-th align="center">材料档次</uni-th>
							<uni-th align="center">施工工艺</uni-th>
							<uni-th align="center">材料价格区间</uni-th>
							<uni-th align="center">操作</uni-th>
						</uni-tr>
						<uni-tr v-for="(itemData, index) in DetailList" :key="index">
							<uni-td>{{getItemShowName(itemData.unitCommonPart)}} </uni-td>
							<uni-td>{{getItemShowName(itemData.decorationPartName)}} </uni-td>
							<uni-td>{{getItemShowName(itemData.decoratingMaterialName)}} </uni-td>
							<uni-td>{{getItemShowName(itemData.materialGradeName)}} </uni-td>
...
<script>
	...
	let fieldList = [{
		...
		{
			label: "装修部位",
			field: "decorationPartName"
		},
		{
			label: "装修材料",
			field: "decoratingMaterialName"
		},
		{
			label: "材料档次",
			field: "materialGradeName"
		},
		{
			label: "施工工艺",
	...
	export default {
		...
		onNavigationBarButtonTap() {
			...
			uni.navigateTo({
				url: "./basicUnitDecorateEdit?" + utils.parseParam(param)
			});
		},
		onBackPress() {
