<template>
	...
	<view>
		<view class="content">
			...
			<ly-tree ref="tree" :showRadio="showRadio"  node-key="id" :tree-data="dataTreeList" :toggle-expend-all="defaultExpandAll"
				@node-expand="" @node-click="" @radio-change="handleRadioChange" />
		</view>
		...
		<view class="uni-flex uni-row" style="-webkit-justify-content: center;justify-content: center;">
			...
			<view style="margin-left:30px;"><button @click.stop="openView" class="mini-btn" type="primary" size="mini">查看</button></view>
