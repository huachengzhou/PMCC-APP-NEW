		...
		<uni-forms :modelValue="formData" ref="form" validate-trigger="bind" err-show-type="undertext" :rules="rules">
			<uni-group  title="基本信息" mode="card">
				...
				<uni-forms-item  required name="actualStandardAmount" label="实际金额(元)" label-align="right" >
						<uni-easyinput   type="digit" v-model="formData.actualStandardAmount" placeholder="实际金额" ></uni-easyinput>
				</uni-forms-item>
				...
				<uni-forms-item required name="file" label="附件" label-align="right">
					<common-file-picker  :appKey="appkey"
...
<script>
	...
	export default {
		...
		async onLoad() {
			...
			//var  s ='{\"testText\":\"你想好多好多好多\",\"testTT\":\"记得接电话\",\"daere\":\"2021-07-14\",\"textrdo\":\"6\",\"textrdo_name\":\"住宿费\"}'
			await this.getDynamicFormDatas(this.formData.twoLevel.id);
			//this.areaId = '500'
			this.notSaved =false;
		},
		watch: {
