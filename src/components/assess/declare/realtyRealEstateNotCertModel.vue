	...
	<view style="margin-top: 40px;">
		...
		<uni-forms :modelValue="formData" ref="form" validate-trigger="bind" err-show-type="undertext" :rules="rules">
			...
			<uni-group title="基本信息" mode="card">
				...
				<uni-forms-item required  name="certName" label="批文文号" label-align="right">
					<uni-easyinput type="text" v-model="formData.certName" placeholder="批文文号" />
				</uni-forms-item>
				...
				<uni-forms-item  name="ownership" label="权利人" label-align="right">
					<uni-easyinput type="text" v-model="formData.ownership" placeholder="权利人" />
				</uni-forms-item>
			...
			<uni-group title="坐落信息" mode="card">
				<uni-forms-item  name="beLocated" label="坐落" label-align="right">
			...
			<uni-group mode="card">
				...
				<uni-forms-item name="houseCertUse" label="房屋用途类型" label-align="right">
				...
				<uni-forms-item name="houseCertUseCategory" label="房屋用途类别" label-align="right">
				...
				<uni-forms-item name="nature" label="房屋性质" label-align="right">
					<assess-picker :dataInput="'nature'" :dataList="natureList" :dataValue="formData.nature"
						@dataResult="initFormPickerResult">
					</assess-picker>
				</uni-forms-item>
				<uni-forms-item  name="evidenceArea" label="证载面积" label-align="right">
				...
				<uni-forms-item  name="registrationAuthority" label="登记机关" label-align="right">
				...
				<uni-forms-item  name="other" label="其它" label-align="right">
					<uni-easyinput type="text" v-model="formData.other" placeholder="其它" />
				</uni-forms-item>
